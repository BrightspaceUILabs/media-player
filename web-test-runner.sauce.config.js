...
const sauceLabsCapabilities = {
	name: '@brightspace-ui-labs/media-player unit tests',
	// eslint-disable-next-line no-undef
	build: `@brightspace-ui-labs/media-player ${process.env.GITHUB_REF ?? 'local'} build ${process.env.GITHUB_RUN_NUMBER ?? ''}`
};
